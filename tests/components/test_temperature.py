...
class TestTemperature(unittest.TestCase):
    ...
    def _valid_tests(self, raw, temperature, dew_point):
        t = Temperature(raw)
    ...
    def test_valid_positive_positive(self):
        self._valid_tests("21/12", 21, 12)

    def test_valid_positive_negative(self):
        self._valid_tests("21/M12", 21, -12)

    def test_valid_negative_negative(self):
        self._valid_tests("M01/M04", -1, -4)
    ...
    def test_invalid_no_numbers(self):
        self._invalid_tests("M/M")

    def test_invalid_no_separator(self):
        self._invalid_tests("1200")
